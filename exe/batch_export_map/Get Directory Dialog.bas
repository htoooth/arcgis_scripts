...
'Private Const BIF_NEWDIALOGSTYLE = &H40         'per creare nuove sottocartelle
...
Public Function BrowseForFolder(owner As Form, Title As String, StartDir As String) As String
  ...
  With tBrowseInfo
    ...
    .ulFlags = BIF_RETURNONLYFSDIRS + BIF_DONTGOBELOWDOMAIN + BIF_STATUSTEXT   'senza nuove sottocartelle
    '.ulFlags = BIF_RETURNONLYFSDIRS Or BIF_DONTGOBELOWDOMAIN Or BIF_STATUSTEXT Or BIF_NEWDIALOGSTYLE    'crea nuove sottocartelle
